...
3. After step 2, you should have a lot more columns with specific commodity details like production, imports/exports, etc. Select just the columns `Commodity_Description`, `Country_Name`, `Market_Year`, `Production`, `Imports`, `Exports` and rename these as "commodity", "country", "year", "production", "import", "export"; also keep `Total.Distribution` and `Domestic.Consumption`, no need to rename these. In addition, please also sort rows by commodity, then country, then year.
