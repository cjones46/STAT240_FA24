...
* For example, we asked: *If 36.8% of the shirts Bret wore to lecture last semester were navy, can we conclude that 36.8% of all his shirts are navy?*

* The answer to that question was **no**. Bret's choice of what shirt to wear to lecture is **not a random choice from the larger population of shirts**; for example, he avoids pajama shirts and old shirts and more often picks more "professional" shirts.
...
* On the other hand, if your experiment was **draw 10 random shirts from Bret's wardrobe and record what percent of them are navy**, that would be a representative sample. Whatever percentage you got from that would be "unbiased"; not necessarily *correct*, but it is *valid to guess* that value of the parameter based on the statistic.
...
* In statistical inference, we almost never get to know what % of all Bret's shirts are navy (the population parameter). We only know that we didn't do anything wrong when we obtained our guess of 30%.
